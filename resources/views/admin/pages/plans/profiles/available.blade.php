...
@section('title', 'Profiles available for the plan {$plan->name}')
...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('plans.profiles.available', $plan->id) }}" class="active">Available</a></li>
    </ol>

    <h1>Profiles available for the plan <strong>{{ $plan->name }}</strong></h1>
